...
@ManagedBean(name = "sexoRenaviEVController")
@ViewScoped
public class SexoRenaviEVController implements Serializable {
   ...
   public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("SexoRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
