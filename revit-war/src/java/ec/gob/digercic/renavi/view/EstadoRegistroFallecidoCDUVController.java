...
@ManagedBean(name = "estadoRegistroFallecidoCDUVController")
@ViewScoped
public class EstadoRegistroFallecidoCDUVController implements Serializable {

    private EstadoRegistroFallecido current;
    @EJB
    private ec.gob.digercic.renavi.ejb.EstadoRegistroFallecidoFacadeLocal ejbFacade;
    private String tituloPantalla;

    public EstadoRegistroFallecidoCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar estado de registro para fallecido";
            }else{
                tituloPantalla = "Crear estado de registro de para fallecido";
            } 
    ...
    public EstadoRegistroFallecido getSelected() {
        if (current == null) {
            current = new EstadoRegistroFallecido();
        }
        return current;
    }
