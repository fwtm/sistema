...
@ManagedBean(name = "madreRenaviIndocCDLController")
@ViewScoped
public class MadreRenaviIndocCDLController implements Serializable {
    ...
    private List<ec.gob.digercic.renavi.ws.TblSauregUsuario> tblSauregUsuarioList;//JJHF CAMBIO LOG IN
    ...
    private String passbusq;
    private String nombreMadre;
    private String cedulaMad;
    private String fechaNacMad;
    private String pass;
    ...
    public MadreRenaviIndocCDLController() {
    }
    ...
    public String getPassbusq() {
        return passbusq;
    }

    public void setPassbusq(String passbusq) {
        this.passbusq = passbusq;
    }
    ...
    public ec.gob.digercic.renavi.ws.TblSauregUsuario getTblSauregUsuario() {//JJHF CA,BIO LOGIN
        return tblSauregUsuario;//JJHF CA,BIO LOGIN
    }

    public void setTblSauregUsuario(ec.gob.digercic.renavi.ws.TblSauregUsuario tblSauregUsuario) {//JJHF CA,BIO LOGIN
        this.tblSauregUsuario = tblSauregUsuario;//JJHF CA,BIO LOGIN
    }
...
//            malformaciones = null;
    ...
    /*CAMBIO PARA VALIDAR EL NUMERO DE CELULAR FWTM 26-01-2016*/
    ...
    /**
     * Metodo para guardar la informacion en el tab de la madre indocumentada
     */
    public void saveM1() {
        try {
        ...
        try {
            ...
            if (hijosAux == null) {
                ...
                if (current.getIdMad() == null) {
                    ...
                    current.setNombrMad(this.getApellidoMad().concat(" ").concat(this.getNombreMad()));
                    current.setApellidosMadIndoc(this.getApellidoMad());//DFJ
                    current.setNombresMadIndoc(this.getNombreMad());//DFJ
                    current.setStatus(JsfUtil.ESTADO_REG_ACTIVO);
                    hijoAux.setApellNacViv(this.getApellidoMad());
                    hijoAux.setCampoInecCodPaisMad(hijoAux.getFkIdPaisMad().getCodigPais());
                    current.setFkIdTipoIdent(ejbFacadeTipIdent.find(JsfUtil.STAT_INDOC));
                    current.setPasapMad(passbusq);
                ...
                current.setNombresMadIndoc(this.getNombreMad());//DFJ
                hijoAux.setApellNacViv(this.getApellidoMad());
                System.out.println("--> " + current.getIdMad());
                ejbFacade.edit(current);
                System.out.println("--> " + current.getNombrMad());
    ...
    public void saveD() {
        ...
        if (estado != null) {
            ...
            //Esta es la parte que mestra el popup para escoger sicreamos madre doc o indoc
...
//            RequestContext.getCurrentInstance().execute("PF('cdIndocumentada').show()");
    ...
    public static class MadreRenaviControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            try {
                ...
                MadreRenaviIndocCDLController controller = (MadreRenaviIndocCDLController) facesContext.getApplication().getELResolver().
    ...
    public String getCedulaMad() {
        return cedulaMad;
    }

    public void setCedulaMad(String cedulaMad) {
        this.cedulaMad = cedulaMad;
    }

    public String getFechaNacMad() {
        return fechaNacMad;
    }

    public void setFechaNacMad(String fechaNacMad) {
        this.fechaNacMad = fechaNacMad;
    }
    ...
    /**
     * Metodo para calcular la edad de la madre no identificada AL SELECCIONAR
    ...
    public byte[] pdfSinFirma(NacidoVivoRenavi nv, ec.gob.digercic.renavi.ws.TblSauregUsuario usuarioFirma) throws JRException, IOException, SQLException {//JJHF CAMBIO LOGIN
        try {
    ...
    public void iniciar() throws ParseException {
        try {
            ...
            tblSauregUsuario = userLgn;//JJHF CAMBIO LOGIN
             /**/
    ...
    public void buscarMadre() {
        // pass = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("pass");
        this.BusquedaWS(passbusq);
    }
    ...
    public void BusquedaWS(String cdl) {
        ...
        try {
            ...
            if (perso.getCodigoError().equals("000") || (Integer.parseInt(perso.getCodigoError()) >= 200)) {
                String sexo;
                sexo = perso.getCodigoGenero().toString();
                System.out.println("sexo " + sexo);

                // if(sexo == "2"){
                //   MadreRenavi passp = new MadreRenavi();
                nombreMadre = perso.getNombre().toString();
                cedulaMad = perso.getCedula().toString();
                fechaNacMad = perso.getFechaNacimiento().toString();
                RequestContext.getCurrentInstance().update("form_cont:contTab:nombrem");
                RequestContext.getCurrentInstance().update("form_cont:contTab:cedulam");
                RequestContext.getCurrentInstance().update("form_cont:contTab:fecham");
                RequestContext.getCurrentInstance().update("form_cont:contTab:indocDialog");

                RequestContext.getCurrentInstance().update("form_cont:contTab:passMadBusq");
                RequestContext.getCurrentInstance().execute("PF('indoDialog').show();");
