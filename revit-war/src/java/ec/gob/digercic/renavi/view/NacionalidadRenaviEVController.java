...
@ManagedBean(name = "nacionalidadRenaviEVController")
@ViewScoped
public class NacionalidadRenaviEVController implements Serializable {
    ...
    public NacionalidadRenaviEVController() {
    }
    ...
    public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("NacionalidadRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
