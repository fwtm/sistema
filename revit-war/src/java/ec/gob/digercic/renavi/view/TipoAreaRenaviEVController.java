...
@ManagedBean(name = "tipoAreaRenaviEVController")
@ViewScoped
public class TipoAreaRenaviEVController implements Serializable {
    ...
    public TipoAreaRenaviEVController() {
    }
   ...
   public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("TipoAreaRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
