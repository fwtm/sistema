...
@ManagedBean(name = "respuestaMuerteViolentaCDUVController")
@ViewScoped
public class RespuestaMuerteViolentaCDUVController implements Serializable {

    private RespuestaMuerteViolenta current;
    @EJB
    private ec.gob.digercic.renavi.ejb.RespuestaMuerteViolentaFacadeLocal ejbFacade;
    private String tituloPantalla;

    public RespuestaMuerteViolentaCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar respuesta muerte violenta";
            }else{
                tituloPantalla = "Crear respuesta muerte violenta";
            } 
    ...
    public RespuestaMuerteViolenta getSelected() {
        if (current == null) {
            current = new RespuestaMuerteViolenta();
        }
        return current;
    }
