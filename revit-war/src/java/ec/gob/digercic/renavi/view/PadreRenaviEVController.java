...
@ManagedBean(name = "padreRenaviEVController")
@ViewScoped
public class PadreRenaviEVController implements Serializable {
    ...
    public PadreRenaviEVController() {
    }
    ...
    public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("PadreRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
