...
@ManagedBean(name = "nivelInstruccionRenaviEVController")
@ViewScoped
public class NivelInstruccionRenaviEVController implements Serializable {
    ...
    public NivelInstruccionRenaviEVController() {
    }
   ...
   public String getOperacion() {
    ...
    public void iniciar() {
        try{
            ...
            if(operacion.equals("ver")){
                id = new BigDecimal(FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("idNivIns"));
    ...
    public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("NivelInstruccionRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
