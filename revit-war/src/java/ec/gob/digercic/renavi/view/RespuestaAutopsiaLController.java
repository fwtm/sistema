...
@ManagedBean(name = "respuestaAutopsiaLController")
@ViewScoped
public class RespuestaAutopsiaLController implements Serializable {

    private List<RespuestaAutopsia> items;
    @EJB
    private ec.gob.digercic.renavi.ejb.RespuestaAutopsiaFacadeLocal ejbFacade;

    public RespuestaAutopsiaLController() {
    }
    ...
    public List<RespuestaAutopsia> getItems() {
        if(items == null){
            items = new ArrayList<RespuestaAutopsia>();
        }
        return items;
    }
    ...
    @FacesConverter(forClass = RespuestaAutopsia.class)
    public static class RespuestaAutopsiaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            try{
                ...
                RespuestaAutopsiaLController controller = (RespuestaAutopsiaLController) facesContext.getApplication().getELResolver().
                        getValue(facesContext.getELContext(), null, "respuestaAutopsiaLController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof RespuestaAutopsia) {
                RespuestaAutopsia o = (RespuestaAutopsia) object;
                return getStringKey(o.getIdResAut());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + RespuestaAutopsia.class.getName());
            }
        }
    }
