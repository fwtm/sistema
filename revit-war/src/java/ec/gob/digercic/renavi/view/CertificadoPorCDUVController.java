...
@ManagedBean(name = "certificadoPorCDUVController")
@ViewScoped
public class CertificadoPorCDUVController implements Serializable {

    private CertificadoPor current;
    @EJB
    private ec.gob.digercic.renavi.ejb.CertificadoPorFacadeLocal ejbFacade;
    private String tituloPantalla;

    public CertificadoPorCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar certificado por";
            }else{
                tituloPantalla = "Crear certificado por";
            } 
    ...
    public CertificadoPor getSelected() {
        if (current == null) {
            current = new CertificadoPor();
        }
        return current;
    }
