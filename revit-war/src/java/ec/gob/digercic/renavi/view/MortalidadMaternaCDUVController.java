...
@ManagedBean(name = "mortalidadMaternaCDUVController")
@ViewScoped
public class MortalidadMaternaCDUVController implements Serializable {

    private MortalidadMaterna current;
    @EJB
    private ec.gob.digercic.renavi.ejb.MortalidadMaternaFacadeLocal ejbFacade;
    private String tituloPantalla;

    public MortalidadMaternaCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar mortalidad materna";
            }else{
                tituloPantalla = "Crear mortalidad materna";
            } 
    ...
    public MortalidadMaterna getSelected() {
        if (current == null) {
            current = new MortalidadMaterna();
        }
        return current;
    }
