...
@ManagedBean(name = "solicitanteFallecimientoCDUVController")
@ViewScoped
public class SolicitanteFallecimientoCDUVController implements Serializable {

    private SolicitanteFallecimiento current;
    @EJB
    private ec.gob.digercic.renavi.ejb.SolicitanteFallecimientoFacadeLocal ejbFacade;
    private String tituloPantalla;

    public SolicitanteFallecimientoCDUVController() {
    }
    ...
    public SolicitanteFallecimiento getSelected() {
        if (current == null) {
            current = new SolicitanteFallecimiento();
        }
        return current;
    }
