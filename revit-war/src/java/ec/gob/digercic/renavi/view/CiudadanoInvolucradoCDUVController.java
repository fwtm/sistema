...
@ManagedBean(name = "ciudadanoInvolucradoController")
@SessionScoped
public class CiudadanoInvolucradoCDUVController implements Serializable {

    private CiudadanoInvolucrado current;
    @EJB
    private ec.gob.digercic.renavi.ejb.CiudadanoInvolucradoFacadeLocal ejbFacade;
    private String tituloPantalla;

    public CiudadanoInvolucradoCDUVController() {
    }
    ...
    public CiudadanoInvolucrado getSelected() {
        if (current == null) {
            current = new CiudadanoInvolucrado();
        }
        return current;
    }
