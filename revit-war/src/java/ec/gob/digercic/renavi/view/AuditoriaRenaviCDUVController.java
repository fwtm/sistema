...
import ec.gob.digercic.renavi.entities.AuditoriaRenavi;
...
@ManagedBean(name = "auditoriaRenaviCDUVController")
@ViewScoped
public class AuditoriaRenaviCDUVController implements Serializable {

    private AuditoriaRenavi current;
    @EJB
    private ec.gob.digercic.renavi.ejb.AuditoriaRenaviFacadeLocal ejbFacade;
    private String tituloPantalla;

    public AuditoriaRenaviCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar día";
            }else{
                tituloPantalla = "Crear día";
            } 
    ...
    public AuditoriaRenavi getSelected() {
        if (current == null) {
            current = new AuditoriaRenavi();
        }
        return current;
    }
