...
@ManagedBean(name = "estadoFirmaRenaviEVController")
@ViewScoped
public class EstadoFirmaRenaviEVController implements Serializable {
    ...
    public EstadoFirmaRenaviEVController() {
    }
    ...
    public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("EstadoFirmaRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
