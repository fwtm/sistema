...
@ManagedBean(name = "alfabetismoRenaviEVController")
@ViewScoped
public class AlfabetismoRenaviEVController implements Serializable {
    ...
    public AlfabetismoRenaviEVController() {
    }
    ...
    public String editar(){
        try{
            ...
            JsfUtil.displayMessage(ResourceBundle.getBundle("/ec/gob/digercic/renavi/view/resources/Mensajes").getString("AlfabetismoRenaviActualizado"), JsfUtil.INFO_MESSAGE);
            return "View";
