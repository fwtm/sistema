...
@ManagedBean(name = "tipoMuerteViolentaCDUVController")
@ViewScoped
public class TipoMuerteViolentaCDUVController implements Serializable {

    private TipoMuerteViolenta current;
    @EJB
    private ec.gob.digercic.renavi.ejb.TipoMuerteViolentaFacadeLocal ejbFacade;
    private String tituloPantalla;

    public TipoMuerteViolentaCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar tipo muerte violenta";
            }else{
                tituloPantalla = "Crear tipo muerte violenta";
            } 
    ...
    public TipoMuerteViolenta getSelected() {
        if (current == null) {
            current = new TipoMuerteViolenta();
        }
        return current;
    }
