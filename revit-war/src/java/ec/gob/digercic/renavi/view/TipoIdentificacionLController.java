...
import ec.gob.digercic.renavi.entities.TipoIdentRenavi;
...
@ManagedBean(name = "tipoIdentificacionLController")
@ViewScoped
public class TipoIdentificacionLController implements Serializable {

    private List<TipoIdentRenavi> items;
    @EJB
    private ec.gob.digercic.renavi.ejb.TipoIdentRenaviFacadeLocal ejbFacade;

    public TipoIdentificacionLController() {
    }
    ...
    public List<TipoIdentRenavi> getItems() {
        if(items == null){
            items = new ArrayList<TipoIdentRenavi>();
        }
        return items;
    }
    ...
    @FacesConverter(forClass = TipoIdentRenavi.class, value = "tipoIdentificacionConverter")
    public static class TipoIdentificacionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            try{
                ...
                TipoIdentificacionLController controller = (TipoIdentificacionLController) facesContext.getApplication().getELResolver().
                        getValue(facesContext.getELContext(), null, "tipoIdentificacionLController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoIdentRenavi) {
                TipoIdentRenavi o = (TipoIdentRenavi) object;
                return getStringKey(o.getIdTipoIdent());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TipoIdentRenavi.class.getName());
            }
        }
    }
