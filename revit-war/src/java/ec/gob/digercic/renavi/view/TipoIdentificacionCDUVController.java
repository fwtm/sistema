...
@ManagedBean(name = "tipoIdentificacionCDUVController")
@ViewScoped
public class TipoIdentificacionCDUVController implements Serializable {

    private TipoIdentRenavi current;;
    @EJB
    private ec.gob.digercic.renavi.ejb.TipoIdentRenaviFacadeLocal ejbFacade;
    private String tituloPantalla;

    public TipoIdentificacionCDUVController() {
    }
    ...
    public void iniciar() {
        try{
            ...
            if(operacion != null){
                ...
                tituloPantalla = "Editar tipo identificación";
            }else{
                tituloPantalla = "Crear tipo identificación";
            } 
    ...
    public TipoIdentRenavi getSelected() {
        if (current == null) {
            current = new TipoIdentRenavi();
        }
        return current;
    }
