 ...
 */
public abstract class SauregAbstractFacade<T> implements AbstractFacadeLocal<T> {

    @PersistenceContext(unitName = "saureg-ejbPU")
    //@PersistenceContext(unitName = "revit-ejbPU")
    protected EntityManager em;
    protected Class<T> entityClass;

    public SauregAbstractFacade(EntityManager em, Class<T> entityClass) {
        this.em = em;
        this.entityClass = entityClass;
    }

    public SauregAbstractFacade() {
